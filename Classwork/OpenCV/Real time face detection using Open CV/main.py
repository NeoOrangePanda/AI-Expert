...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        else: print("Error: Invalid choice! Please select number from 1 to 6")

interactive_edge_detection(r'Classwork\OpenCV\Real time face detection using Open CV\example.jpg')